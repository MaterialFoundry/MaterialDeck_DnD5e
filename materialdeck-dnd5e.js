...
Hooks.once('MaterialDeck_Ready', () => {
    Helpers.attackMode = new materialDeck.Helpers.ModeSwitcher('default', 'mdUpdateAttackMode');
    Helpers.rollType = new materialDeck.Helpers.ModeSwitcher('default', 'mdUpdateRollType');
